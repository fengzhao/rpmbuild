...
./configure \
    ...
    --with-threads \
    --with-compat \
    --add-module=/root/rpmbuild/SOURCES/openresty/modules/nginx-auth-ldap \
...
ln -snf %{orprefix}/nginx/sbin/nginx %{buildroot}/usr/sbin/nginx
ln -snf %{orprefix}/nginx/conf %{buildroot}/etc/nginx
